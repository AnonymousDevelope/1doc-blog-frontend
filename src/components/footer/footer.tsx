...
const Footer = () => {
  return (
    <footer className={`${styles.footer} dark:text-foreground gap-4 h-60 w-full flex-col-reverse sm:flex-col bg-slate-900/15`}>
      <div className="container border-b-[1px] border-b-slate-700 mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <p className="text-sm text-gray-300 flex flex-row gap-3"><MailIcon size={"20px"} /><span>Email: info@example.com</span></p>
            <p className="text-sm text-gray-300 flex flex-row gap-3"><PhoneCall size={"20px"} /><span>Phone: +1 (555) 123-4567</span> </p>
            <p className="text-sm text-gray-300 flex flex-row gap-3"><MapPinIcon size={"20px"} /><span>Address: 123 Tech St, City</span></p>
            <p className="text-sm text-gray-300 flex flex-row gap-3"><HeadphonesIcon size={"20px"} /><span>Support: 123 234 56 67</span></p>
          </div>
